:: Run-Engine-Ollama-OpenClaw-EnableInternetAccess.bat
::
...
echo Enabling OpenClaw web search...
echo.
...
echo Selecting Ollama Web Search provider...
echo.
call "%_OPENCLAW_CMD%" config set tools.web.search.provider ollama
...
call "%_OPENCLAW_CMD%" config get tools.web.search
